...
for i in range(4):
    ...
    if (board[i][6] < board[i][0]):
        ...
        result.append('d')
    elif (board[i][7] < board[i][1]):
        result.append('d')
    elif (board[i][5] > board[i][3]):
        result.append('d')
    # 한 점
    elif ((board[i][6] == board[i][0]) and ((board[i][7] == board[i][1]) or (board[i][5] == board[i][3]))):
        result.append('c')
    elif ((board[i][4] == board[i][2]) and ((board[i][7] == board[i][1]) or (board[i][5] == board[i][3]))):
        result.append('c')
